...
namespace MusicDBApp.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AlbumsID,AlbumName,Grammy,AlbumCoverArt,ArtistID")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AlbumsID,AlbumName,Grammy,AlbumCoverArt,ArtistID")] Album album)
        {
            if (ModelState.IsValid)
            {
